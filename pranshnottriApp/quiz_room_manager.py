...
class QuizRoomManager:
	...
	def before_first_join_processing(self, memb_id, memb_session_id):
		...
		members_dict = {}
		members_dict[memb_id] = [session['user_name'].lower(), memb_session_id]
		session["room_code"] = new_code
		
		print(new_code)
		runs_dict = {}
		new_room = QuizRoom(new_room_id, room_name, members_dict, quiz_room_creation_datetime, new_code, runs_dict, "")
